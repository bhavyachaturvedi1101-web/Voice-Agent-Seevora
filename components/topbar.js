  ...
  return `
    <header class="topbar" id="main-topbar" style="background:transparent; border-bottom:none;">
      ...
      <div class="topbar-actions" style="display:flex; flex-direction:row; flex-wrap:nowrap; align-items:center; gap:10px;">
        ${actions}
        <button class="btn" id="admin-btn" style="background:#f1f5f9; color:#0f172a; border-radius:12px; font-size:0.75rem; padding:4px 12px; font-weight:600; border:1px solid #e2e8f0; display:flex; align-items:center; white-space:nowrap;">
        ...
        <button class="btn" id="logout-btn" style="background:transparent; color:#ef4444; border-radius:12px; font-size:0.75rem; padding:4px 12px; font-weight:600; border:1px solid rgba(239,68,68,0.2); display:flex; align-items:center; white-space:nowrap;">
